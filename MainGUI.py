...
and download the search results.
"""
class MainGUI(QWidget):
    ...
    adding QWidgets to this MainGUI.
    """
    ...
    def add_tree_view(self):
        """
        Adds a QTreeView to this MainGUI. For
        storing search results from iTunes API.
        """
    ...
    def add_search_button(self):
        ...
        self.search_button.setFixedWidth(125)
    ...
    def add_dl_button(self):
        ...
        self.dl_button.setFixedWidth(125)
    ...
    def add_playlist_button(self):
        ...
        """
        self.pl_button = QPushButton("Edit Playlists")
        self.pl_button.setFixedWidth(125)
    ...
    """
    All functions below are linked to events.
    """
    def add_track_list(self, track_list):
        """
        Adds a list of tracks to this
        QStandardItemModel.
        """
        added = []
    ...
    def search_button_push(self):
        """
        Searches the iTunes api for the entered
        QLineEdit fields. Then adds their data
        into the QStandardItemModel.
        """
    ...
    def download_button_push(self):
        """
        Downloads checked boxes into the Fixed directory.
        """
        try:
    ...
    def playlist_button_push(self):
        """
        Opens a new GUI window to edit and play
        playlists.
        """
